...
import com.example.handsign_translator_app.StaticGestureInfoHelper;
...
import com.example.handsign_translator_app.utils.ConstantsStatic;
...
public class StaticGestureClassifier {
    // Number of input features (sensor readings for THUMB, INDEX, MIDDLE, RING, LITTLE)
    private static final int INPUT_FEATURES = ConstantsStatic.INPUT_FEATURES;
    // Number of output classes
    private static final int OUTPUT_CLASSES = ConstantsStatic.OUTPUT_CLASSES;
    ...
    private StaticGestureInfoHelper gestureInfoHelper;

    /**
     * Constructor initializes the TensorFlow Lite interpreter and loads gesture information.
     */
    public StaticGestureClassifier(AssetManager assetManager, Context context) {
        try {
        ...
        gestureInfoHelper = new StaticGestureInfoHelper(assetManager, context);
    }
     ...
     */
    public StaticGesture classifyStaticGesture(int[] sensorData) {
     ...
     */
    private StaticGesture getGestureFromIndex(int index) {
