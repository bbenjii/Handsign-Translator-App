...
public class StaticGesture extends Gesture{
     ...
     */
    public StaticGesture(String translation, String imagePath, String label) {
     ...
     */
    public StaticGesture(String translation, String imagePath, String label, String customTranslation) {
        this.translation = translation;
        this.imagePath = imagePath;
